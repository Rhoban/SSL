...
void test_to_dot(){
    {
        ...
        assert(
            ...
            " graph [ordering=\"out\"]\n"
            "\n"
            " v0 [label=\"end\" shape=\"circle\"];\n"
            " v1 [label=\"middle\" shape=\"circle\"];\n"
            " v2 [label=\"start\" shape=\"doublecircle\"style=\"filled\" fillcolor=\"gold\"];\n"
            "\n"
        ...
        assert(
            ...
            " graph [ordering=\"out\"]\n"
            "\n"
            " v0 [label=\"end\" shape=\"circle\"style=\"filled\" fillcolor=\"gold\"];\n"
            " v1 [label=\"middle\" shape=\"circle\"];\n"
            " v2 [label=\"start\" shape=\"doublecircle\"];\n"
            "\n"
            " v2->v1 [label=\"initialisation\"];\n"
            " v1->v0 [label=\"next\"];\n"
            "}\n"
