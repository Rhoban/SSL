...
Frame_changement::Frame_changement()
  : origin(0.0, 0.0), basis(Matrix2d::identity()), basisChangement(Matrix2d::identity()), rotation_angle_from_basis(0.0)
{
}

void Frame_changement::set_frame(const rhoban_geometry::Point& origin, const Vector2d& v1, const Vector2d& v2)
{
