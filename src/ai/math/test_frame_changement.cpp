...
{
  Frame_changement fc;
  fc.set_frame(rhoban_geometry::Point(0.0, 0.0), Vector2d(1.0, 0.0), Vector2d(0.0, 1.0));
...
{
  Frame_changement fc;
  fc.set_frame(rhoban_geometry::Point(1.0, 2.0), Vector2d(1.0, 0.0), Vector2d(0.0, 1.0));
...
TEST(test_frame_changement, rotation)
{
  ...
  fc.set_frame(rhoban_geometry::Point(0.0, 0.0), Vector2d(c, s), Vector2d(-s, c));
...
TEST(test_frame_changement, all)
{
  ...
  double c = .5;
  double s = std::sqrt(3.0) / 2.0;
  fc.set_frame(rhoban_geometry::Point(1.0, 2.0), Vector2d(c, s), Vector2d(-s, c));
