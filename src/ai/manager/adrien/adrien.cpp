        ...
        SUPPORT, std::shared_ptr<Strategy::Strategy>(
            new Strategy::From_robot_behavior(
                ...
                [&](double time, double dt){
                    ...
                    f->declare_robot_to_follow(0, Vector2d(1.0, 1.0), Vision::Team::Ally);
...
void Adrien::analyse_data(double time){
...
void Adrien::choose_a_strategy(double time){
...
void Adrien::update(double time){
