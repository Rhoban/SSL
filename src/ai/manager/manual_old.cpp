...
namespace manager
{
Manual_old::Manual_old() : Manager(), goal_to_positive_axis_(true), ally_goalie_id_(0), opponent_goalie_id_(0)
{
...
void Manual_old::assignPointOfViewAndGoalie()
{
  // DEBUG(team_color);
...
void Manual_old::defineGoalToPositiveAxis(bool value)
{
  this->goal_to_positive_axis_ = value;
}

void Manual_old::update(double time)
{
