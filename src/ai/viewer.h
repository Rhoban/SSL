...
private:
     ...
     */
    static int callback_http_dummy(struct lws *wsi, enum lws_callback_reasons reason,
     ...
     */
    static int callback_viewer(struct lws *wsi, enum lws_callback_reasons reason,
                            void *user, void *in, size_t len);
