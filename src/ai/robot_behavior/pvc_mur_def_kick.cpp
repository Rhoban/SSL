...
{
MurDefKick::MurDefKick(bool fixed_consign_follower_without_repsecting_authorized_location_bool)
...
void MurDefKick::update(double time, const data::Robot& robot, const data::Ball& ball)
{
