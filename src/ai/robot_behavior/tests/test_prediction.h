...
{
class TestPrediction : public RobotBehavior
{
private:
...
public:
  TestPrediction(rhoban_geometry::Point point = rhoban_geometry::Point(0, 0), double reach_radius = 0.01,
         bool angle = false);
