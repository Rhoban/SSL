...
{
WallStop1::WallStop1() : RobotBehavior(), follower_(Factory::fixedConsignFollower())

{
}

void WallStop1::update(double time, const data::Robot& robot, const data::Ball& ball)
{
...
Control WallStop1::control() const
{
...
rhoban_ssl::annotations::Annotations WallStop1::getAnnotations() const
{
