...
GoCorner::GoCorner()
  : RobotBehavior(), follower_(Factory::fixedConsignFollower()), target_corner_(opponentCornerLeft())
{
}

void GoCorner::update(double time, const data::Robot& robot, const data::Ball& ball)
{
