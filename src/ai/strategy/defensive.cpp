...
Defensive::Defensive(Ai::AiData & ai_data):
    ...
    obstructeur(std::shared_ptr<Robot_behavior::Obstructor>(
...
void Defensive::assign_behavior_to_robots(
  ...
  int id_to_obstruct = number_of_threat_max( Vision::Team::Opponent );
...
//
bool Defensive::get_starting_position_for_goalie(
