...
//
bool StrikerV2::get_starting_position_for_goalie(rhoban_geometry::Point& linear_position,
...
rhoban_ssl::annotations::Annotations StrikerV2::get_annotations() const
{
