...
Defensive2::Defensive2()
  : Strategy()
  , degageur1_(std::shared_ptr<robot_behavior::keeper::Clearer>(new robot_behavior::keeper::Clearer()))
  , obstructeur1_(std::shared_ptr<robot_behavior::Obstructor>(new robot_behavior::Obstructor()))
  , degageur2_(std::shared_ptr<robot_behavior::keeper::Clearer>(new robot_behavior::keeper::Clearer()))
