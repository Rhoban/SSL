...
void AI::setManager(std::string managerName)
{
  ...
  GlobalDataSingleThread::singleton_.ai_data_.current_manager_ = strategy_manager_;
  GlobalDataSingleThread::singleton_.ai_data_.current_manager_name_ = managerName;
