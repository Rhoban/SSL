 ...
 */
class RobotControlWithTargetTrackingAndCircleFollowing : public RobotControlWithTargetTracking
{
public:
...
protected:
  ContinuousAngle robot_destination_;
  rhoban_geometry::Circle circle_trajectory_;
};
